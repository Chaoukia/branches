...
class BranchMulti:
    ...
    def __init__(self, id_branch, attributes, bit_vector, K):
        """
        Description
        -----------------------
    ...
    def split(self, X_branch, y_branch, lambd, sorted_branch, attribute, n_total, K):
        ...
        try:
            ...
            try:
                ...
                branch_child_1 = BranchMulti(id_branch_child_1, attributes_children, bit_vector_child_1, K)
                branch_child_1.evaluate(None, lambd, n_total, self.n_samples - branch_child.n_samples, self.n_classes - branch_child.n_classes)
            ...
            branch_child = BranchMulti(id_branch_child, attributes_children, bit_vector_child, K)
            branch_child.evaluate(None, lambd, n_total, self.n_samples - branch_child_1.n_samples, self.n_classes - branch_child_1.n_classes)
...
class LatticeMulti:
    ...
    Description
    -----------------------
    Class describing a lattice for a binary classification problem with ordinally encoded predictors.
    
    Class Attributes:
    -----------------------    
    """
    
    def __init__(self, attributes, n_total, K):
        """
        Description
        -----------------------
        ...
        self.K = K
        self.root = BranchMulti('', attributes, np.full(n_total, True), K)
    ...
    def expand(self, branch, data, lambd, sorted_branch):
        ...
        for attribute in branch.attributes:
            ...
            branch.split(X_branch, y_branch, lambd, sorted_branch, attribute, n_total, self.K)
